...
//			
//			barWidth1=document.documentElement.clientWidth||document.body.clientWidth;
//			slideHeight=document.getElementById("cont").clientHeight;
//			
//		}

    function getBarWidth1() {
    ...
    iView.prototype = {
        ...
        setCaption: function () {
            ...
            captions.each(function (i) {
                var caption = $(this),
                    ...
                    w = (caption.data('width')) ? caption.data('width') : caption.width() + 20,
        ...
        addStrips: function (vertical, opts) {
            ...
            for (var i = 0; i < opts.strips; i++) {
                var stripWidth = iv.slider.width() / opts.strips,
...
//				} else {
                var width = ((vertical) ? '0px' : stripWidth + 0.05 + 'px'),
                ...
                if (opts.strips == 20) {
                    if (vertical == true) {
                        var strip = $('<div class="iview-strip"></div>').css({
                            ...
                            top: top,
                            left: left,
                            background: 'url("' + iv.defs.image.data('iview:image') + '") no-repeat ' + bgPosition + " / 100% 2000%",
                            opacity: 0
                        });
                    }
                    else {
                        var strip = $('<div class="iview-strip"></div>').css({
                            ...
                            top: top,
                            left: left,
                            background: 'url("' + iv.defs.image.data('iview:image') + '") no-repeat ' + bgPosition + " / 2000% 100%",
                            opacity: 0
                        });
                    }
                }
                else if (opts.strips == 1) {
                    var strip = $('<div class="iview-strip"></div>').css({
                        width: width,
                        height: height,
                        top: top,
                        left: left,
                        background: 'url("' + iv.defs.image.data('iview:image') + '") no-repeat ' + bgPosition + " / 100% 100%",
                        opacity: 0
                    });
                }
            ...
            for (var rows = 0; rows < iv.options.blockRows; rows++) {
                for (var columns = 0; columns < iv.options.blockCols; columns++) {
                    ...
                    var block = $('<div class="iview-block"></div>').css({
                        ...
                        left: (columns * blockWidth) + 'px',
                        background: 'url("' + iv.defs.image.data('iview:image') + '") no-repeat ' + bgPosition + " / 1000% 500%",
                        opacity: 0
                    });
        ...
        runTransition: function (fx) {
            ...
            switch (fx) {
                ...
                case 'strip-bottom-fade':
                    ...
                    strips.each(function () {
                        var strip = $(this);
                        var width = getBarWidth1() / 20 + 0.05;
                        var height = strip.height();
                ...
                case 'block-drop-random':
                    ...
                    blocks.each(function (i) {
                        var block = $(this),
                            h = block.height(),
                            w = getBarWidth1() / 10 + 0.1,// block.width()
                            top = block.css('top');
        ...
        goTo: function (action) {
            ...
            if (!action) {
                ...
                if (action == 'prev' || action == 'next') {
                    iv.slider.css('background-image', 'url("' + iv.defs.image.data('iview:image') + '") no-repeat');
                }
            }
            iv.defs.slide++;
            ...
            if (iv.options.fx.toLowerCase() == 'random') {
                var transitions = new Array('left-curtain', 'right-curtain', 'top-curtain', 'bottom-curtain', 'strip-down-right', 'strip-down-left', 'strip-up-right', 'strip-up-left', 'strip-up-down', 'strip-up-down-left', 'strip-left-right', 'strip-left-right-down', 'slide-in-right', 'slide-in-left', 'slide-in-up', 'slide-in-down', 'fade', 'block-random', 'block-fade', 'block-fade-reverse', 'block-expand', 'block-expand-reverse', 'block-expand-random', 'zigzag-grow-top', 'zigzag-grow-bottom', 'zigzag-drop-top', 'zigzag-drop-bottom', 'strip-left-fade', 'strip-right-fade', 'strip-top-fade', 'strip-bottom-fade', 'block-drop-random');
