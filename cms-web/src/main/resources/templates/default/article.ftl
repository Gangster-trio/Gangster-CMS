...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="${requst.contextPath}/${BaseSkinPath}/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- Bootstrap core CSS -->
...
<#--<link href="/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">-->
    ...
    <link href="${requst.contextPath}/${BaseSkinPath}/css/clean-blog.min.css" rel="stylesheet">
