<#macro showTree Category>
    ...
    <#--<#else>-->
            <li class="nav-item">
                <a style="font-size: 12px;font-weight: 600;color: #ffffff" class="nav-link" href="/view/category/${Category.categoryId}">${Category.categoryTitle}</a>
            </li>
    <#--</#if>-->
...
<#macro header site CategoryList>
<!-- Navigation -->
