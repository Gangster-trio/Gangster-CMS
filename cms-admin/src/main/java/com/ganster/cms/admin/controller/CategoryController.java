...
public class CategoryController extends BaseController {
    ...
    public Message checkCategory(@PathVariable Integer categoryId, @RequestParam Integer judge) {
        // TODO: 2018/4/9  待添加权限
        Category category = categoryService.selectByPrimaryKey(categoryId);
        if (category == null) {
            return super.buildMessage(1, "没有找到对应的栏目", null);
        }
        ...
        try {
            ...
            LOGGER.error("审核栏目出现错误:{}", e.getMessage());
            return super.buildMessage(1, "审核栏目出现错误，请重试", null);
        }
        if (count == 0) {
            return super.buildMessage(1, "审核栏目出现错误，请重试", null);
        }
        return super.buildMessage(0, "success", null);
    }
}